<x-app-layout>
    ...
    <div class="py-8" style="background-color: #FBF8F3; min-height: calc(100vh - 65px);">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <h1 class="bistro-font-display text-3xl mb-6" style="color:#2B211D;">Tambah Menu Baru</h1>
                ...
                <div class="p-6">
                    <form action="{{ route('admin.menus.store') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" class="bistro-field" placeholder="Contoh: Pisang Goreng Coklat">
                            @error('name') <p class="text-sm mt-1" style="color:#8C332B;">{{ $message }}</p> @enderror
                        </div>

                        <div>
                            <label class="bistro-label">Deskripsi</label>
                            <textarea name="description" rows="3" class="bistro-field">{{ old('description') }}</textarea>
                        </div>

                        <div>
                            <label class="bistro-label">Harga (Rp)</label>
                            <input type="number" name="price" value="{{ old('price') }}" class="bistro-field" placeholder="Contoh: 15000">
