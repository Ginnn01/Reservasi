<x-app-layout>
    ...
    <div class="py-8" style="background-color: #FBF8F3; min-height: calc(100vh - 65px);">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <h1 class="bistro-font-display text-3xl mb-6" style="color:#2B211D;">Edit Meja {{ $table->table_number }}</h1>
                ...
                <div class="p-6">
                    <form action="{{ route('admin.tables.update', $table) }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="table_number" value="{{ old('table_number', $table->table_number) }}" class="bistro-field">
                        ...
                        <div>
                            ...
                            <input type="number" name="capacity" value="{{ old('capacity', $table->capacity) }}" class="bistro-field">
                        ...
                        <div>
                            ...
                            <select name="status" class="bistro-field">
                                <option value="active" {{ $table->status === 'active' ? 'selected' : '' }}>Aktif</option>
                                <option value="inactive" {{ $table->status === 'inactive' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                        </div>
